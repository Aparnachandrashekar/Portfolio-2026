...
export const WORK_ITEMS: Project[] = [
  ...
  },
  {
    ...
    title: 'Spotify Axis - A Music Discovery Feature',
  ...
  },
  {
    ...
    title: 'Spotify - App Review Engine and RAG',
  ...
  },
  {
    ...
    description: 'A facts-only RAG chatbot for objective mutual fund queries including NAV, expense ratio, exit load, SIP minimums, and AUM, sourced exclusively from official Groww pages.',
  ...
  // Case Studies
  {
    slug: 'spotify-axis-case-study',
    title: 'Spotify - A Music Discovery Case Study',
    description: 'Spotify’s strategic challenge: drive meaningful discovery and break users out of repeat listening loops — a case study on how Axis reframes “similar songs” around beat, mood, and lyrics.',
    href: 'https://drive.google.com/file/d/1Bh-yoO6atbbraMShMpt8TrLUFGlLEsat/view?usp=sharing',
    category: 'Case Study',
    orientation: 'landscape',
  },
  {
